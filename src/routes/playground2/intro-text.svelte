...
<BasicPage title='Intro Text' path='/playground2'></BasicPage>
...
.shadow{
    ...
    width: 100%;
    height: 50px;
    background: radial-gradient(rgba(black,0.2),transparent,transparent);
    filter: blur(5px);
...
.textBox .text h2{
    font-size: calc(var(--section-height) * 0.16);
    color: #fff;
}
</style>