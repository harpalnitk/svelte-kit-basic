<main>
    <div class="container animate flip">
        <div class="one animate pop delay-1">Pop</div>
        <div class="two animate slide delay-2">Slide</div>
        <div class="three animate blur delay-3">Blur</div>
        <div class="four animate grow delay-4">grow</div>
         <div class="five animate splat delay-5">splat</div>
      </div>
