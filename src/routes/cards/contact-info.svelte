...
<BasicPage title='Contact Info card' path='/cards'></BasicPage>
...
<h4>9419189780</h4>
    ...
    <div class="box">
        <div class="imgBx">
<img src="/img/misc/email.png" alt="">
        </div>
        <div class="content">
            <div class="icon">
                <img src="/img/misc/email.png" alt="">
    ...
    <div class="box">
        <div class="imgBx">
<img src="/img/misc/location.png" alt="">
        </div>
        <div class="content">
            <div class="icon">
                <img src="/img/misc/location.png" alt="">
            ...
            <h3>Address</h3>
            <h4>282-A Kings Valley, Georgia</h4>
