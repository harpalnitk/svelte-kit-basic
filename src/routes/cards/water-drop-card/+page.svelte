<main class='flex-center'>
    <div class="container">
        <div class="drop" style='--clr:#ff0f5b'><div class="content">
            <h2>01</h2>
            <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Iure, unde!</p>
            <a href="#01">Read More</a>
        </div></div>
        <div class="drop" style='--clr:#be01fe'><div class="content">
            <h2>02</h2>
            <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Iure, unde!</p>
            <a href="#02">Read More</a>
        </div></div>
        <div class="drop" style='--clr:#01b4ff'><div class="content">
            <h2>03</h2>
            <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Iure, unde!</p>
            <a href="#03">Read More</a>
        </div></div>
    </div>
</main>
