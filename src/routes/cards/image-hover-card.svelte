...
<div class="container">
    <div class="box">
        <img src="/img/misc/img1.png" alt="img-1">
    </div>
    <div class="box">
        <img src="/img/misc/img2.png" alt="img-1">
    </div>
</div>
</main>
...
.container{
    ...
    justify-content: center;
    align-items: center;
    -webkit-box-reflect: below 1px linear-gradient(transparent,transparent,transparent, #000400);
}
.container .box{
    position: relative;
    width: 320px;
