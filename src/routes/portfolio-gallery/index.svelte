<script>
	import { images } from '$lib/portfolio-gallery/imgData';
	import { categories } from '$lib/portfolio-gallery/imgData';
	import ButtonContainer from '$lib/components/UI/ButtonContainer.svelte';
	import Gallery from '$lib/portfolio-gallery/Gallery.svelte';
	import ImageCard from '$lib/portfolio-gallery/ImageCard.svelte';
